"""
Django settings for UrbanGent project.
...
SECRET_KEY = 'django-insecure-!6aei@inap95+z^$g)%f*^zlfq%lvng!!@kuztznoi$g0^3k7^'
...
WSGI_APPLICATION = 'UrbanGent.wsgi.application'
